...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-2">
      ...
      <h1 className="mb-4 text-2xl font-bold">Please login to find home services near you</h1>
      <p className="mb-8">If you don't already have an account, click join below!</p>
      <button
